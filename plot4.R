plot4 <- function() {
    ...
    # setup rows and columns to plot into
    par(mfrow = c(2, 2))
    
    # First Plot
    plot(plotData$Date_time, plotData$Global_active_power, type="l", main="", xlab = "", ylab="Global active power")

    # Second Plot
    plot(plotData$Date_time, plotData$Voltage, type="l", main="", xlab = "Date/Time", ylab="Voltage")
    ...
    # Fourth Plot
    plot(plotData$Date_time, plotData$Global_reactive_power, type="l", main="", xlab = "Date/Time", ylab="Global Reactive Power")
